...
export default async function UserProfilePage({ params }: UserProfilePageProps) {
  ...
  <Link
    href="/events"
    className="inline-flex items-center rounded-xl mt-4 border border-slate-700 bg-slate-900 px-5 py-3 text-sm font-semibold text-slate-200 transition hover:border-blue-500 hover:text-white"
  >
    ← Back to events
  </Link>
</div>
