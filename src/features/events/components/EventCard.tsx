...
export function EventCard({ event }: EventCardProps) {
  ...
  return (
    <Link href={`/events/${event._id}`} className="group block">
      <article className="h-full rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-blue-200 hover:shadow-md">
